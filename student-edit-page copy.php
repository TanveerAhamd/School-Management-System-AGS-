                ...
                <div class="card-body py-2 b-0">
                  <div class="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="mb-2 mb-md-0">
                      <h5 class="page-title mb-0">Manage Student(Edit)</h5>
                    </div>
              ...
              <div class="row mt-4">
                <div class="col-12">
                    ...
                    <div class="col-md-4 mt-2 border rounded">
                      <div class="card-body p-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-1">
                          <label class="mb-0 fw-bold ">Transport:</label>
                          <div class="d-flex gap-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-1">
                          <label class="mb-0 fw-bold ">Bus Route:</label>
                          <div class="d-flex gap-2">
                        ...
                        <div class="mt-1">
                          ...
                          <div class="d-flex flex-wrap gap-2 ">
                            <label class="mx-1"><input type="checkbox"> Sports</label>
                            <label class="mx-1"><input type="checkbox"> Painting</label>
                            <label class="mx-1"><input type="checkbox"> Reading</label>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="d-flex justify-content-center gap-3 mt-4">
                    <button class="btn btn-primary px-4 mx-1" type="submit">Save</button>
